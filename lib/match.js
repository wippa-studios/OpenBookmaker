...
// remainder -> LTP/history/volume. All inside ONE transaction; ledger ops
// nest via their own SAVEPOINTs.
...
function positionsFor(db, userId) {
  ...
  const myBets = db
    .prepare(
      `SELECT mt.market_id, mt.selection_id, mt.price, mt.stake_cents,
